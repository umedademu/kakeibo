...
const updates = [
  {
    ...
    date: "2026年9月4日",
    dateTime: "2026-09-04",
    title: "資産推移を30日と90日で切り替え可能に",
    changes: [
      "未来と過去の資産推移グラフに、30日と90日の表示切り替えを追加しました。",
      "未来の資産推移表でも、30日分と90日分を切り替えて確認できるようにしました。",
      "記録済みの過去の総資産を30日分または90日分で確認できる表画面を追加しました。",
    ],
  },
  {
    version: "v0.1.29",
  ...
  },
  {
    ...
    date: "2026年9月4日",
    dateTime: "2026-09-04",
    title: "各管理一覧を直接編集できる操作へ変更",
    changes: [
      "固定費、収入、借金の各行から編集ボタンを削除しました。",
      "編集したい行をクリックまたはタップすると、入力欄へ切り替わるようにしました。",
      "編集ボタン用の列をなくし、摘要と金額を表示する幅を広げました。",
    ],
  },
  {
    version: "v0.1.27",
    date: "2026年9月4日",
    dateTime: "2026-09-04",
    title: "収入の反映方法を項目ごとに選択可能に",
    changes: [
      "収入の着金日の右隣に反映列を追加し、一括または日割りを項目ごとに選べるようにしました。",
      "一括は着金日に全額を加算し、日割りは月の日数で割った金額を毎日加算します。",
      "新しい収入の初期値は一括とし、登録済みの収入は従来どおり日割りとして引き継ぎます。",
    ],
  },
  {
    version: "v0.1.26",
